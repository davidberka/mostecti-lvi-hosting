(window.cookieConsentSettings = {
      ...
      settings_modal: {
        ...
        blocks: [
          ...
          },
          {
            ...
            toggle: { value: "social", enabled: !1, readonly: !1 },
          },
        ],
      },
    },
  ...
  document
    ...
    .forEach(function (e) {
      e.src = "/cookie-consent-frame.html";
    }),
  document.querySelectorAll("[data-cookie-placeholder]").forEach(function (e) {
    e.addEventListener("click", function () {
      void 0 !== e.dataset.cookiePlaceholder &&
        document.querySelector('[data-cc="c-settings"]').click();
    });
  });
